...
public class Filter {
    ...
    public var intensity: Double? = FilterIntensity.defaultIntensity.rawValue
    public var filter: ((Pixel, FilterOption?, Double?) -> (Pixel))
    
    public init(filter: @escaping ((Pixel, FilterOption?, Double?) -> (Pixel)), option: FilterOption = FilterOption.none, intensity: Double = FilterIntensity.defaultIntensity.rawValue) {
        self.option = option
        self.filter = filter
...
public class FilterFormula {
    ...
    public func intensifyColor(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
    ...
    public func invertColor(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        let intensityValue = (intensity ?? defaultIntensity.rawValue)
        var pixel = pixel
    ...
    public func swapColor(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        let intensityValue = (intensity ?? defaultIntensity.rawValue)
        var pixel = pixel
    ...
    public func removeColor(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        var pixel = pixel
    ...
    public func changeTransperency(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        let intensityValue = (intensity ?? defaultIntensity.rawValue)
        var pixel = pixel
    ...
    public func changeContrast(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
    ...
    public func changeBrightness(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        let intensityValue = (intensity ?? defaultIntensity.rawValue)
        var pixel = pixel
    ...
    public func monochromeColor(pixel: Pixel, option: FilterOption?, intensity : Double?) -> Pixel {
        let intensityValue = (intensity ?? defaultIntensity.rawValue)
        var pixel = pixel
        pixel.red = Clamp(number: Double(pixel.red) * intensityValue)
